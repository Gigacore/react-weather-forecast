...
describe("<Dashboard />", () => {
  it("renders an `.weather-dashboard`", () => {
    const wrapper = render(<Dashboard store={mockStore({ weatherStation: {status: "success"}})} />);
  ...
  it("should contain app heading", () => {
    const wrapper = mount(<Dashboard store={mockStore({ weatherStation: {status: "success"}})} />);
